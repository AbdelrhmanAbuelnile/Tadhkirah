    ...
    <div>
        <header class=" shadow-sm bg-Dark-Blue">
            <nav class=" container mx-auto p-4 flex justify-between">
                <NuxtLink to="/" class="font-semibold text-slate-100 hover:text-[#23cfa1] duration-300">Tadhkirah</NuxtLink>
                <Search />
                ...
                <div v-if="show" class="absolute left-0 z-10 top-[60px] min-h-screen h-full bg-Dark-Grayish-Blue w-full text-slate-100 text-2xl pt-2 font-semibold">
                    <ul class="flex flex-col justify-center items-start px-4 gap-8">
                        <li>
                            <NuxtLink @click="show = !show" to="/" class="hover:text-[#23cfa1] duration-300">Home</NuxtLink>
                        </li>

                        <li>
                            <NuxtLink @click="show = !show" to="/fehrs" class="hover:text-[#23cfa1] duration-300">Fehrs</NuxtLink>
                        </li>

                        <li>
                            <NuxtLink @click="show = !show" to="/randomAyah" class="hover:text-[#23cfa1] duration-300">Random Ayah</Nuxtlink>
                        </li>

                        <li>
                            <nuxt-link @click="show = !show" to="/tafser" class="hover:text-Neon-Green duration-300">Tafser</nuxt-link>
                        </li>

                        <li>
                            <nuxt-link @click="show = !show" to="/azkar" class="hover:text-Neon-Green duration-300">azkar</nuxt-link>
                        </li>

                        <li>
                            <nuxt-link @click="show = !show" to="/hadith" class="hover:text-Neon-Green duration-300">Hadith</nuxt-link>
                        </li>
                    </ul>
                </div>
            </nav>
